class Viewer {
    constructor (config) {
        ...
        // console.log(this.app.view.width + "px");
        // this.app.view.style.top = - this.app.view.height + "px"
        // this.app.view.style.left = - this.app.view.width + "px"
        // this.app.view.style.position = "relative"
        this.app.view.id = "L2dCanvasReal"
        // this.canvas.html(this.app.view);
        this.app.view.style.transform += 
`translate(${this.app.view.width / 2 - this.app.view.height * scale / 2}px, 
${this.app.view.height / 2 - this.app.view.height * scale / 2}px)`
        this.app.view.style.transform += `scale(${scale})`
        // this.app.view.style.left = -this.app.view.width * scale / 2 + "px"
        ...
        this.app.view.addEventListener('mousemove', (event) => {
            ...
            if (this.model) {
                ...
                this.model.pointerX = -mouse_x / this.app.view.height * scale;
                this.model.pointerY = -mouse_y / this.app.view.width * scale;
            }
        });
